...
const read_json_dir_1 = __importDefault(require("read-json-dir"));
...
const jsonPath = path_1.default.resolve('./test/jsons');
const jsonData = read_json_dir_1.default(jsonPath, {});
